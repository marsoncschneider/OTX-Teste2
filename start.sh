...
do
	...
	mysqldump -u$usersql -p$sqlpassword --add-drop-table --add-locks --allow-keywords --extended-insert --quick --compress $servername > /home/parrot/database/$databasefile
	gzip /home/parrot/database/$databasefile-f
