...
-- local voices = { {text = 'Venha para a maior loja de moedas do UltraTibia em Thais, aqui voce guarda, transfere, saca e investe, venha conhecer nosso CDB e nossos investimentos.'} }
-- if VoiceModule then
