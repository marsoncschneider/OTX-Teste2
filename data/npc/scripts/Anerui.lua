...
keywordHandler:addKeyword({'bow'}, StdModule.say, {npcHandler = npcHandler, text = "Bow, bunda, and spear are the hunters' best friends. In the northeast of the town one of us may sell such tools."})
